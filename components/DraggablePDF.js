...
const DraggablePDF = (props) => {
  ...
  return (
    <div className="transition-all duration-100 ease-out p-4 flex flex-row shadow-lg items-center border-[1px] justify-between rounded-xl bg-white border-primary border-opacity-50">
